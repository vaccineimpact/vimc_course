...
You will need a copy of the data ([`Rubella-UK.dat`](https://tjmckinley.github.io/VIMCCoursePracticals/Rubella-UK.dat)), which you can download via the link. We will begin by loading and checking the contents of the rubella data table: 
