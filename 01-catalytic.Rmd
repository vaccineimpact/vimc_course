...
You will need to copy two files from the shared drive that contain the rubella data itself ([`Rubella-UK.dat`](https://tjmckinley.github.io/VIMCCoursePracticals/data/Rubella-UK.dat)) and another that defines various helper functions we will use in the practical (`CatalyticModel.R`).
