...
All required data and script files can be downloaded [here](https://vaccineimpact.github.io/vimc_course/Materials/BYOM/R0_files.zip). Please download this ZIP file and extract the files to your working directory.
```
