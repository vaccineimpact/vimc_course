...
file.copy("Materials/Statistics/StatsLectureNotes.pdf", "docs/Materials/Statistics/StatsLectureNotes.pdf", overwrite = TRUE)
...
A PDF handout for the slides for the Statistical Modelling part of this workshop can be found [here](`r pathtofiles`/Materials/Statistics/StatsLectureNotes.pdf).
```
