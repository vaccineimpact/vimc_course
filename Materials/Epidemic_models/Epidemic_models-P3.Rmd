...
```{task}
Load the R script called [`Det_SIR.R`](./Materials/Epidemic_models/Functions/Det_SIR.R) and adapting your code from the previous section make a plot that overlays the deterministic solution with the output of the stochastic model.
