...
## set knitr options
opts_chunk$set(cache = TRUE, tidy.opts = list(width.cutoff = 55), tidy = FALSE, fig.align = "center", fig.width = 5, fig.height = 5, multCode = FALSE, renderTask = TRUE, renderSol = TRUE, renderInfo = TRUE, collapsible = TRUE)
